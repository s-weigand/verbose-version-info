...
@pytest.mark.xfail(reason="The warning is suppressed by the settings")
def test_local_git_commit_id_uncommited_changes_warning_deactivated(
    monkeypatch: MonkeyPatch, dirty_vsc_path: Path
):
    """Warning if uncommitted changes are present, does not ."""
